...
class Boggle():
    ...
    def check_valid_word(self, board, word):
        ...
        word_exists = word in self.words #cross check dict
        valid_word = self.find(board, word.upper()) #Looks for UPPERCASED word in board, doesn't raise exception if not found
